...
# find where internal_actualizar_progreso is declared
idx = text.find('fn internal_actualizar_progreso')
# find where the first conn.execute for 'YA_LA_VI' starts inside it
idx2 = text.find('conn.execute(', idx)
idx3 = text.find('YA_LA_VI', idx2)
idx_end = text.find('} else {', idx3)
